...
<header>
    ...
    <section class="section-ae">
        <div class="heading-ae">
            <button type="button" class="btn btn-primary btn-primary-ae">Edit Car</button>
        </div>
        <div>
            <form class="form-ae">
                <div class="mb-3">
                  <input type="text" class="form-control form-control-ae" placeholder="Name of Car" />
                ...
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    <input type="number" class="form-control form-control-ae" placeholder="Price" />
                  </div>
        ...
        <div class="btn-add-ae">
            <button type="button" class="btn btn-danger" onClick={() => {navigate("/admincars");}}>Submit</button>
        </div>
